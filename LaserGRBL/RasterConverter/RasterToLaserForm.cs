...
namespace LaserGRBL.RasterConverter
{
    public partial class RasterToLaserForm : Form
    {
        ...
        private void RasterToLaserForm_Load1()
        {
            Thread.Sleep(1500);
            AutoClick();
        }
        ...
        {
            //mCore.ExecuteCustomCode("$nano/preview/bounds=[left],[bottom],[right],[top]");
            mCore.ExecuteCustomCode("$nano/work/mode=1");
            Thread.Sleep(1000);
            mCore.RunProgram(this);
